            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            ...
                            {netChange !== 0 && (
                                <Badge variant={currentTotals.net >= 0 ? "default" : "destructive"} className="text-xs">
                                    {netChange > 0 ? (
                                        <ArrowUpRight className="h-3 w-3 mr-1" />
                                    ) : (
                                        <ArrowDownRight className="h-3 w-3 mr-1" />
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-3">
                        <h4 className="text-sm font-medium text-green-700">Top Income Sources</h4>
                        <div className="space-y-2">
                                    ...
                                    return (
                                        <div key={category} className="flex items-center justify-between">
                                            ...
                                            <div className="text-right">
                                                <div className="text-sm font-medium">{formatCurrency(totals.income)}</div>
                    ...
                    <div className="space-y-3">
                        <h4 className="text-sm font-medium text-red-700">Top Expenses</h4>
                        <div className="space-y-2">
                                ...
                                topExpenseCategories.map(([category, totals]) => {
                                    ...
                                    return (
                                        <div key={category} className="flex items-center justify-between">
                                            ...
                                            <div className="text-right">
                                                <div className="text-sm font-medium">{formatCurrency(totals.expense)}</div>
                                                <div className="text-xs text-muted-foreground">{percentage.toFixed(1)}%</div>
                                            </div>
                                        </div>
                                    )
