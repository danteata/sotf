...
export function UserNav() {
  ...
  return (
    <div className="flex items-center gap-4"> {/* wrap avatar and notification icon in a div */}
      <Button variant="ghost" size="icon" className="relative h-8 w-8 rounded-full"> {/* notification icon button */}
